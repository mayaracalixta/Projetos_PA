...
/**
 * @brief MainWindow::tcpConnect - Conecta  com o servidor
 */
...
/**
 * @brief MainWindow::tcpDisconnect - Disconecta do servidor
 */
...
/**
 * @brief MainWindow::getData - Inicia a a captura de dados
  * @details Pega os dados no intervalo de 30 em 30 amostras com um tempo determinado pelo usuário
 */
...
/**
 * @brief MainWindow::timerEvent - Configura o temporizador
 * @details - Configura o getData() de acordo com o intervalo fornecido pelo usuario
 */
...
/**
 * @brief MainWindow::stopData - Mata o temporizador e encerra o getData();
 */
...
/**
 * @brief MainWindow::updateIp - Atualiza a lista de produtores conectados
 */
